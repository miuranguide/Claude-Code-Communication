...
class AuthNotifier extends StateNotifier<AuthState> {
  ...
  Future<bool> login(String loginId, String password) async {
    ...
    try {
      // loginId is used as email format: loginId@rakugaki.app
  ...
  /// Called after successful Firebase Auth to set user data
  ...
  Future<String?> changePassword(
    ...
    try {
      ...
      FirestoreService.instance.writeLog(
        ...
        actorUid: fbUser.uid,
        detail: 'Broadcaster app password change',
      );
